...
- Follow [@getbootstrap on Twitter](https://twitter.com/{{ .Site.Social.twitter }}).
...
You can also follow [@getbootstrap on Twitter](https://twitter.com/{{ .Site.Social.twitter }}) for the latest gossip and awesome music videos.
